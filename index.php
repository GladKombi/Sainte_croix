...
<body>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown has-dropdown "><a href="#"><span class="btn-getstarted">Login<i class="bi bi-chevron-down"></i></span> </a>
            <ul>
              <li><a href="views/login.php?fonction=admin">Responsanble Administratif</a></li>
              <li><a href="views/login.php?fonction=enseignant">Comptable</a></li>
              <li><a href="views/login.php?fonction=enseignant">Enseigant</a></li>
              <li><a href="views/login.php?fonction=eleve">Eleve</a></li>
            </ul>
          </li>
        </ul>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <img src="photo/hero-bg.jpg" alt="" data-aos="fade-in">

      <div class="container">
        <h2 data-aos="fade-up" data-aos-delay="100" class="">Sainte_Croix,<br>School complex</h2>
        <p data-aos="fade-up" data-aos-delay="200">We have a school complex that organizes kindergarten, primary and secondary school</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
            <img src="photo/about.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
            <h3>Voluptatem dignissimos provident quasi corporis</h3>
            <p class="fst-italic">
            The Sainte Croix school complex is a young institution of Catholic obedience t
            hat has obtained its ministerial decree since 2018, for reasons of construction of 
            their buildings and classrooms, the Holy Cross Institute has officially launched school 
            activities for the year to 2022-2023.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>République Démocratique du Congo</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Province du Nord-Kivu, ville de Butembo</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Commune Bulengera, dans le quartier de Kihathe</span></li>
            </ul>
      ...
      <div class="container">
        ...
        <div class="row">
              ...
              <div class="course-content">
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assetts/img/trainers/trainer-1-2.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="course-item">
              <img src="assetts/img/course-2.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assetts/img/trainers/trainer-2-2.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="course-item">
              <img src="assetts/img/course-3.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assetts/img/trainers/trainer-3-2.jpg" class="img-fluid" alt="">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="">Sainte_Croix</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Nord-Kivu</p>
            <p>Butembo, Twaga</p>
            <p class="mt-3"><strong>Phone:</strong> <span>+243 997 019 883</span></p>
            <p><strong>Email:</strong> <span>saintcroix@gmail.com</span></p>
          </div>
