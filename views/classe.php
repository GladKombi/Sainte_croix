                        ...
                        <form action="<?= $url ?>" class="shadow p-3" method="POST">
                            ...
                            <div class="row">
                                <div class="col-12 p-3">
                                    ...
                                    <input required type="text" class="form-control" name="description" placeholder="Entrez la description" <?php if (isset($_GET['idClass'])) { ?>
                                        value="<?php echo $tab['nomClasse']; ?> <?php }?>">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-6 p-3">
                                    <label for="">Orientation <span class="text-danger">*</span></label>
                                    <select required name="Option" id="" class="form-select" <?php if (isset($_GET['idClass'])) { ?>
                                        value="<?php echo $tab['orientation']; ?> <?php }?>" >
                                        <?php
