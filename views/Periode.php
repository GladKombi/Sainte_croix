...
require_once('../models/select/select-Periodes.php'); //Appel du script de selection
?>
                        ...
                        <form action="<?= $url ?>" class="shadow p-3" method="POST">
                            ...
                            <div class="row">
                                <div class="col-12 p-3">
                                    ...
                                    <input required type="text" class="form-control" name="description" placeholder="Entrez la description" <?php if (isset($_GET['idPreiode'])) { ?>
                                        value="<?php echo $tab['libelle']; ?> <?php }?>">
                                </div>
                                <div class="col-12 p-3">
