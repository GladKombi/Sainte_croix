                            ...
                            <form action="<?= $url ?>" class="shadow p-3" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                                        ...
                                        <input required type="text" name="adresse" class="form-control" placeholder="Entrez l'adresse" value="">
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                                        ...
                                        <input required type="file" name="photo" class="form-control" placeholder="Choisir la photo de l'enseignant" value="">
                                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='Option.php?idEnseignant=<?= $idEnseignant['id'] ?>' class="btn btn-sm btn-success">
